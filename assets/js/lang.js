...
const TRANSLATIONS = {
  en: {
    ...
    'hero-h1':      'Your Renovation. Done Right. Stress-Free.',
    'hero-h2':      'Renovation & Project Management for Homeowners and Investors in St. Pete, Clearwater, Tampa & Pinellas County',
    'hero-body':    'Whether it\'s your home or your investment — ASCANIA renovates, coordinates, and delivers your project on time, on budget, and to a standard you can rely on. German quality, right here in Tampa Bay.',
    ...
    'pain-1-title': '"I just want it done right, without the headache"',
    'pain-1-body':  'You don\'t have time to chase contractors or fix someone else\'s mistakes. You want one reliable partner.',
    ...
    'pain-5-title': '"I\'m afraid of being overcharged or left with bad work"',
    'pain-5-body':  'Without someone who knows the trade, how do you know the price and quality are fair?',
    ...
    's3-h3':   'Flooring',
    's3-body':  'Professional flooring installation — laminate, vinyl, hardwood, and luxury vinyl plank. Precise prep, clean edges, flawless finish. One of our core specialties, done entirely in-house.',
    ...
    /* WHY ASCANIA */
    'why-eyebrow': 'Why Us',
    'why-h2':      'Why Homeowners & Investors Choose ASCANIA',
    ...
    'usp6-body':  'No hidden costs, no vague estimates. You get a clear scope and a fair price before we start — whether it\'s your home or your investment.',
    ...
    'f-type-homeowner':   'Homeowner Renovation',
  ...
  de: {
    ...
    'hero-h2':      'Renovierung & Projektmanagement für Hauseigentümer und Investoren in Tampa Bay, Florida',
    'hero-body':    'Ob Eigenheim oder Investition — ASCANIA renoviert, koordiniert und liefert Ihr Projekt termingerecht, im Budget und in einer Qualität, auf die Sie sich verlassen können. Deutsche Wertarbeit, hier in Tampa Bay.',
    ...
    'pain-1-title': '„Ich will einfach, dass es richtig gemacht wird — ohne Ärger"',
    'pain-1-body':  'Sie haben keine Zeit, Handwerkern hinterherzulaufen oder Pfusch zu reparieren. Sie wollen einen verlässlichen Partner.',
    ...
    'pain-5-title': '„Ich habe Angst, übers Ohr gehauen zu werden oder schlechte Arbeit zu bekommen"',
    'pain-5-body':  'Ohne Fachwissen: Woher wissen Sie, ob Preis und Qualität stimmen?',
    ...
    's3-h3':   'Bodenbelag',
    's3-body':  'Professionelle Bodenverlegung — Laminat, Vinyl, Parkett und hochwertiges Vinyl. Präzise Vorbereitung, saubere Kanten, makelloses Ergebnis. Eine unserer Kernkompetenzen, komplett in Eigenleistung.',
    ...
    'why-h2':      'Warum Hauseigentümer & Investoren auf ASCANIA setzen',
    ...
    'usp6-body':  'Keine versteckten Kosten, keine vagen Schätzungen. Sie erhalten einen klaren Leistungsumfang und einen fairen Preis, bevor wir beginnen — ob Eigenheim oder Investition.',
    ...
    'f-type-homeowner':   'Eigenheim-Renovierung',
